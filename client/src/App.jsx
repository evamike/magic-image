...
const App = () => {
  return (
      <BrowserRouter>
        ...
        <footer
            className="w-full flex justify-center items-center py-4 border-t border-t-[#e6ebf4]">Magic
          Image via OpenAi - DALL-E
        </footer>
      </BrowserRouter>
  )
}
